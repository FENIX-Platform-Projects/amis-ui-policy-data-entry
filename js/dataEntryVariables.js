define([
    ...
    var optionsDefault = {
        ...
        //MinAVTariffValue_path : 'root.MinAVTariffValue',
        //openListfieldsToDisable : ['policyElement', 'unit', 'source', 'secondGenerationSpecific', 'MinAVTariffValue'],
        openListfieldsToDisable : ['policyElement', 'unit', 'source', 'secondGenerationSpecific'],
